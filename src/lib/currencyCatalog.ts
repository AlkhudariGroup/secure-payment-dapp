...
export const CURRENCY_CATALOG: CatalogEntry[] = [
  { id: "usdt", name: "Tether USD", symbol: "USDT", decimals: 18, defaultSupply: "1000000", contractType: "swapAsset", description: "ربط USDT" },
  ...
  { id: "usdtz", name: "Tether USD Bridged ZED20", symbol: "USDT.z", decimals: 18, defaultSupply: "1000000", contractType: "usdtz", description: "عقد 0x20aE" },
