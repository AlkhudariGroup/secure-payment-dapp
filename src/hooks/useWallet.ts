...
const RPC_ERROR_MSG =
  "المحفظة تستخدم رابط RPC غير صالح أو منتهي. غيّر RPC في إعدادات المحفظة: الإعدادات → الشبكات → Ethereum Mainnet → RPC URL. استخدم مثلاً: https://eth.llamarpc.com أو https://rpc.ankr.com/eth";
